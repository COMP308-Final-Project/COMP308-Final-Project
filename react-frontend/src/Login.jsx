...
export const Login =(props) => {
    ...
    return (
        ...
        <button className="link-btn" onClick={() => props.onFormSwitch("register")}>Forgot the password?</button>

        <button className="link-btn" onClick={() => props.onFormSwitch("register")}>Don't have account? Create new Account</button>
        </div>
    )
}